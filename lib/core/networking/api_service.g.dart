...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://olivedrab-manatee-515331.hostingersite.com/api/';
  }
  ...
  Future<SubCategoriesResponse> getSubCategories() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SubCategoriesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'sub-categoreis',
  ...
  Future<FilterCompaniesResponse> filterCompanies(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FilterCompaniesResponse _value;
    try {
      _value = FilterCompaniesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
